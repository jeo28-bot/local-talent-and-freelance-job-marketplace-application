...
@section('content')
    ...
    {{-- About Us --}}
    <section class="">
    <div class="container mx-auto flex px-5 py-15 flex-col items-center mb-50">
        ...
        <p class="xl:w-7xl text-center mb-8 leading-10 p_font text-gray-300 lg:text-xl max-lg:leading-8"> Our platform is built to connect talented freelancers with clients who need their skills.  
     ...
     {{-- How it works --}}
    <section class="">
    <div class="container mx-auto flex px-5 py-15 flex-col items-center mb-40">
        ...
        <div class="grid md:grid-cols-3 gap-8 max-sm:flex max-sm:flex-col max-sm:items-center justify-center">
            <!-- Step 1 -->
            <div class="p-6 bg-white rounded-2xl shadow-md hover:shadow-lg hover:shadow-blue-400 transition py-20 max-sm:py-10 max-sm:w-[90%]">
            ...
            <div class="max-lg:w-full">
                <div class="flow-root ">
                    <div id="faq-container" class="-my-4 flex flex-col divide-y divide-gray-200">
                        ...
                        <summary class="flex items-center gap-2 cursor-pointer text-gray-900 dark:text-white">
                            
                            <!-- Icon (plus/minus) -->
                            <svg
                            class="size-5 shrink-0 text-blue-500 transition-transform duration-300 group-open:rotate-90"
                        ...
                        <p class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">
                            It’s Jasaan’s <span class="font-bold text-blue-400">first local freelance marketplace</span>, built to connect clients with talented freelancers in service-based industries like makeup artistry, nail technology, hair styling, and photography.
                        </p>
                        </details>
                        ...
                        <p class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">
                            <ul class="list-disc pl-5">
                                <li class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">It’s <span class="font-bold text-blue-400">locally focused</span> on Jasaan and nearby communities.</li>
                                <li class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">Everything you need—<span class="font-bold text-blue-400">profiles, search, communication, and payments</span>—is in one place.</li>
                                <li class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">The system is designed with <span class="font-bold text-blue-400">safety and transparency</span> in mind, with admin monitoring to protect all users.</li>
                                <li class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">It’s <span class="font-bold text-blue-400">accessible on any device</span>—desktop or mobile browser.</li>
                            </ul>
                        </p>
                        </details>
                        ...
                        <p class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">
                            Currently, the platform caters to <span class="font-bold text-blue-400">local service-based</span> industries, including:
                            <ul class="list-disc pl-5">
                                <li class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">Makeup artistry</li>
                                <li class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">Nail technology</li>
                                <li class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">Hair styling</li>
                                <li class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">Photography</li>
                                <li class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">And more freelance skills offered by the Jasaan community.</li>
                            </ul>
                        </p>
                        </details>
                        ...
                        <p class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">
                            Payments and payouts are processed <span class="font-bold text-blue-400">directly within the platform</span>, ensuring smooth transactions and timely releases for freelancers.
                        </p>
                        </details>
                        ...
                        <p class="text-xl max-lg:text-lg p_font mt-2 text-gray-600 dark:text-gray-300">
                            An <span class="font-bold text-blue-400">administrative team</span> actively monitors activity to ensure fairness, trust, and accountability between freelancers and clients.
                        </p>
                        </details>
...
<section class="text-gray-400  body-font relative mb-40">
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2020 KJB Digitals —
      <a href="" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@Jeyow</a>
    </p>
