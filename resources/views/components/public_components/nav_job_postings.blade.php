    ...
    <nav class="w-full  bg-[#1E2939] text-white flex items-center px-8 max-lg:py-4 max-lg:px-4 max-sm:px-2">
      <div class="flex items-center">
        ...
        <div class=" flex ml-10 gap-5 max-lg:hidden">
          <a href="/"  
              class="pages_nav a_font px-2 py-8 cursor-pointer
                  ">
              Home
          </a>
          <a  class="pages_nav a_font px-2 py-8 selected_nav openRestrictedBtn">Job Posting</a>
          <a  class="pages_nav a_font px-2 py-8  openRestrictedBtn">Job Applied</a>
          
            {{-- transaction dropdown --}}
            <div class="flex relative group openRestrictedBtn">
                <a 
      ...
      <div class="ml-auto flex items-center gap-8 max-lg:gap-6 max-sm:gap-4">
        <span class="hidden">
          ...
          <a  class="pages_nav max-lg:hidden openRestrictedBtn">
