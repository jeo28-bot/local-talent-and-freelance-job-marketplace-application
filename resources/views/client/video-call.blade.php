    ...
    <section class="w-full min-h-[80vh] px-10 py-10 max-sm:py-5 max-sm:px-4 ">
        ...
        <div class="xl:w-6xl mx-auto px-5 max-sm:px-3 mb-10 bg-gray-300 shadow-lg rounded-xl p-6">
            ...
            <div class="flex justify-between items-center">
                ...
                {{-- back button --}}
                <a href="{{route('client.messages')}}" class="p-2 bg-gray-200 rounded-full hover:bg-gray-100 cursor-pointer shadow-md">
            ...
            {{-- buttons --}}
            <div class="mt-5 flex flex-row items-center gap-4 justify-cente hidden">
                {{-- mic button --}}
