    ...
    <section class="w-full min-h-[80vh] px-10 py-10 max-sm:py-5 max-sm:px-4">
        ...
        <div class="xl:w-6xl mx-auto px-5 max-sm:px-3 mb-10 pb-10">
            <div class="flex items-center justify-between max-lg:flex-col max-lg:gap-2 max-xl:items-start max-xl:mb-4 mb-5">
                <div>
                    <h1 class="sub_title sm:text-xl">Completed Earnings</h1>
                ...
                <div class="ml-auto max-lg:w-sm max-sm:w-full">
                    ...
                    {{-- search inputs --}}
                    <form action="" method="GET" class="bg-white  shadow-sm rounded-lg max-sm:w-full w-sm p_font max-sm:text-sm flex items-center">
                            {{-- input 1 job title, skills, company --}}
                            <input type="text" name="q" value=""  value="" class="  pl-10 max-sm:pl-7 py-2 rounded-lg p_font max-sm:text-sm w-sm max-lg:w-full" placeholder="Search job title, users, status">
                    ...
                    <div class="bg-white rounded-lg shadow-sm mb-5 border-green-500">
                        ...
                        <div class="w-full rounded-t-lg px-4 py-3 flex items-start justify-between bg-[#1e2939]">
                            <div>
                                ...
                                <a href="{{ route('employee.public_profile', $transaction->client->name) }}" class="home_p_font sm:text-lg text-gray-200 cursor-pointer hover:underline">
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                <div 
                                    ...
                                    <form 
                                        ...
                                        method="POST" 
                                        onsubmit="return confirm('Are you sure you want to arhive this transaction?')">
                                        @csrf
                                        @method('DELETE')
                                        <button 
                                            type="submit" 
    ...
    <div id="transactionModal" class="report_modal fixed top-0 left-0 w-full h-full z-50 hidden max-sm:px-6 bg-black/50 flex justify-center items-start overflow-y-auto py-10">
        <div class="sm:w-lg mt-20 mx-auto p-5 bg-gray-200 rounded-xl shadow-sm">
            ...
            <div class="w-full bg-white p-3 rounded-lg shadow-sm mb-4">
                ...
                <h2 class="home_p_font text-sm text-gray-500 mb-2 max-sm:text-sm">Reference #: <span id="modalRef" class="text-black font-semibold"></span></h2>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelectorAll('.viewDetailsBtn').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                client.innerHTML = '<span class="font-semibold">Client : </span>' + btn.dataset.client;
