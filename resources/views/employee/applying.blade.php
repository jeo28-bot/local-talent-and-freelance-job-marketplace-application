...
@section('content')
    ...
    <section class="px-15 py-10 max-sm:px-7 max-sm:py-6 w-full parent_container">
        <div class=" bg-white rounded-xl shadow-lg xl:w-6xl mx-auto">
            <div class="cover_color h-30 bg-[#1E2939] rounded-t-xl max-sm:h-20"></div>
                ...
                <div class="px-10 content_control pt-10 pb-5 max-sm:px-6">
                    ...
                    <div class="flex  justify-between mb-2 max-sm:flex-col max-sm:gap-3 max-sm:mb-3">
                    ...
                    <div class="div_control flex items-center justify-between flex-col">
                        <div class="div_control max-sm:w-full max-sm:mb-3 w-full mb-5">
                            <div class="div_control flex gap-2 mb-4 max-sm:gap-1">
                                <h3 id="skills" class="px-3 py-1 bg-gray-200 rounded-lg job_posting_company hover:bg-gray-300 hover:text-gray-300 max-sm:text-sm max-sm:px-2">Skills</h3>
                                <h3 id="skills" class="px-3 py-1 bg-gray-200 rounded-lg job_posting_company hover:bg-gray-300 hover:text-gray-300 max-sm:text-sm">Skills</h3>
                                <h3 id="skills" class="px-3 py-1 bg-gray-200 rounded-lg job_posting_company hover:bg-gray-300 hover:text-gray-300 max-sm:text-sm">Skills</h3>
                            </div>
                ...
                <div class="py-5 px-10 max-sm:px-6 max-sm:py-3 border-t-2 border-b-2 border-gray-200">
                    <h1 class="job_posting_title text-xl max-sm:text-lg mb-3 max-sm:mb-1">Job Title</h1>
                    <p class="home_p_font text-lg max-sm:text-sm">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium molestias totam atque quia animi iste perferendis cupiditate, adipisci iure asperiores! Voluptatem quae maxime optio consequuntur tempora earum a, laboriosam nostrum eaque, velit incidunt quasi impedit nam quod assumenda beatae delectus temporibus itaque pariatur sed facere repellendus cupiditate mollitia aperiam? Delectus?</p>
                </div>
      ...
      {{-- menu control --}}
        <div class="sm:w-2xl mt-20 mx-auto p-5 max-sm:p-4 bg-gray-200 opacity-100 rounded-xl shadow-sm">
            ...
            <div class="flex justify-between items-center mb-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" id="close_quick_apply" class="size-5 cursor-pointer  hover:bg-gray-400 rounded-sm max-sm:size-4 bg-gray-300!">
      ...
      {{-- menu control --}}
        <div class="sm:w-2xl mt-20 mx-auto p-5 max-sm:p-4 bg-gray-200 opacity-100 rounded-xl shadow-sm">
            ...
            <div class="flex justify-between items-center mb-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" id="close_report_modal" class="size-5 cursor-pointer  hover:bg-gray-400 rounded-sm max-sm:size-4 bg-gray-300!">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                </svg>
            </div>
             <form action="" class="w-full bg-white p-3 rounded-lg shadow-sm ">
                ...
                <div class="flex">
                <input type="submit" value="Submit Report" class="cursor-pointer bg-[#1E2939] text-white px-7 py-3 max-sm:py-3 max-sm:px-5 rounded-lg hover:opacity-90 max-sm:text-sm text-center ml-auto">
                </div>
             </form>
       </div>
    </div>
