     ...
     <section class="w-ful min-h-[80vh] px-10 py-10 max-sm:py-5 max-sm:px-4 ">
        <div class="xl:w-6xl mx-auto px-5 max-sm:px-3 mb-10">
            ...
            <p class="home_p_font mb-5 text-sm">Jobs you’ve marked to check out when the time is right.</p>
             ...
             {{-- sample 1 job posted --}}
           <div class="bg-white xl:w-full rounded-xl mx-auto shadow-lg px-10 max-sm:px-7 py-6 mb-5 hidden">
                <div class="div_control mb-2 flex flex-row items-center justify-between">
                    ...
                    <svg id="save_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"  class="size-6 cursor-pointer hover:opacity-60 max-sm:size-5">
            ...
            <div class="flex flex-col items-center justify-center py-10 text-center bg-gray-200 rounded-xl">
                ...
                <h2 class="text-xl font-semibold text-gray-800 sub_title_font">No saved jobs yet</h2>
                <p class="text-gray-500 mt-1 home_p_font">When you do, they’ll show up here.</p>
            </div>
