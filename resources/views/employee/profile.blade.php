    ...
    @include('components.nav')
     ...
     <section class="w-ful min-h-[80vh] px-10 py-10 max-sm:py-5 max-sm:px-4 ">
        <div class="sm:w-2xl mx-auto px-5 max-sm:px-3 mb-10">
            ...
            <h1 class="sub_title sm:text-4xl text-lg">Angeline Panhay</h1>
            ...
            Zone 5, Bobontugan, Jasaan Mis. Or</p>
        ...
        <div class="flex items-center justify-between ">
          <h1 class="sub_title sm:text-2xl flex items-center gap-2 mb-3">
            ...
            <div id="skills_added_table" class="flex flex-row flex-wrap gap-2 mb-10">
                <div id="skills_added" class="a_font text-sm px-4 py-2 bg-gray-300 rounded-lg ">Freelance Photography</div>
                <div id="skills_added" class="a_font text-sm px-4 py-2 bg-gray-300 rounded-lg">Nail Technician</div>
                <div id="skills_added" class="a_font text-sm px-4 py-2 bg-gray-300 rounded-lg">Hairdresser</div>
                <div id="skills_added" class="a_font text-sm px-4 py-2 bg-gray-300 rounded-lg">Hairdresser</div>
                <div id="skills_added" class="a_font text-sm px-4 py-2 bg-gray-300 rounded-lg">Hairdresser</div>
                <div id="skills_added" class="a_font text-sm px-4 py-2 bg-gray-300 rounded-lg">Hairdresser</div>
            </div>
