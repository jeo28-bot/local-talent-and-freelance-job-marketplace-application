...
@section('content')
    ...
    <section class="w-full min-h-[80vh] px-10 py-10 max-sm:py-5 max-sm:px-4">
        <div class="xl:w-6xl mx-auto px-5 max-sm:px-3 mb-10">
            ...
            <div class="flex flex-col items-center justify-center py-20 text-center bg-gray-200 rounded-xl">
            ...
            {{-- sample 1 job posted --}}
           <div class="bg-white xl:w-6xl rounded-xl mx-auto shadow-lg px-10 max-sm:px-7 py-6 mb-5 hidden">
         ...
         {{-- pagination for job posted --}}
            <div id="posting_pagination" class="xl:w-6xl mx-auto flex items-center max-sm:flex-col max-sm:items-center gap-2 hidden">
